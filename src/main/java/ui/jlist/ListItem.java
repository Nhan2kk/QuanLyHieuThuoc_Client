...
public class ListItem extends JPanel {
    ...
    private final Image imageDelete = new ImageIcon("src/main/java/ui/jlist/delete.png").getImage();
    private final Image imageDeleteDisable = new ImageIcon("src/main/java/ui/jlist/delete_disable.png").getImage();
    private final Image imageInsert = new ImageIcon("src/main/java/ui/jlist/insert.png").getImage();
    private final Image imageOpen = new ImageIcon("src/main/java/ui/jlist/open.png").getImage();
    ...
    public ListItem(Font font, String text) {
        ...
        panel.add(lb);
        /**
         * điều chỉnh độ rỗng giữa các item
         */
        this.add(panel, "h 50, w 800%");
    }
    ...
    public void movingX(int x) {
        //  Change Miglayout
        mig.setComponentConstraints(panel, "x " + x + ", h 20, w 100%");
        if (x < 0) {
